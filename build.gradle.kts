...
licenseReport {
    renderers = arrayOf<com.github.jk1.license.render.ReportRenderer>(
        com.github.jk1.license.render.InventoryHtmlReportRenderer(
            "report.html",
            "QALIPSIS plugin for the Jackson Project"
        )
    )
            ...
            publications {
                create<MavenPublication>("maven") {
                    ...
                    pom {
                        ...
                        scm {
                            connection.set("scm:git:https://github.com/qalipsis/qalipsis-plugin-jackson.git")
                            url.set("https://github.com/qalipsis/qalipsis-plugin-jackson.git/")
                        }
                    }
                }
            }
