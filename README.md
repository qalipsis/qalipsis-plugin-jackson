...
![CI](https://github.com/qalipsis/qalipsis-plugin-jackson/actions/workflows/gradle-master.yml/badge.svg)
...
The QALIPSIS plugin for the Jackson Project is distributed under the Apache License 2.0, the terms can be
read [here](./LICENSE).
